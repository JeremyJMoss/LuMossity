...
class Field {
    ...
    // ==================================================
    /**
     * Get the instance as a JSON object.
     * @param {boolean} with_old_values - whether we should include old_field_location and old_queryable_value in result.
     * @returns {Object} JSON object related to the instance.
     */
    toJSON( with_old_values = false ) {
        const return_value = {
     ...
     * @throws {AppError} If mysql query fails.
     */
    ...
    /**
     * Checks if default value can be applied to column.
     * @async
     * @method
     * @param {string} default_value - The default value to check against.
     * @param {string} field_type - The field type to check against.
     * @returns {Promise<boolean>} Whether the default value can be applied to the column.
     */
     ...
     * @throws {ValidationError|AppError} If validation of schema fails
     */
     ...
     * @param {*} field_type - The field_type for schema check to see if field config is valid.
